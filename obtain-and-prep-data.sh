...
rclone copy --tpslimit 10 --fast-list -P --drive-shared-with-me ConGen:CSU-con-gen-2020/pre-indexed-chinook-genome  pre-indexed-chinook-genome
...
ln -s /home/mgdesaix@colostate.edu/scratch/chinook-play/chinook-genome-idx genome
